...
pinMode (16, OUTPUT); digitalWrite(16, LOW); delay(50);
...
pinMode (relay33, OUTPUT); pinMode (relay13, OUTPUT);
pinMode (relay23, OUTPUT);
delay(500);
Wire.begin();

lightMeter.begin(); delay(500);
}
void loop() {
...
Serial.println( s); // prints the value read while (s == 0) {
counter++;
Serial.print("counter11=");
Serial.println(counter);
digitalWrite(relay32, LOW); // prints the valu
